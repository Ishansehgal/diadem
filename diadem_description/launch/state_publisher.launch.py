...
def generate_launch_description():
    ...
    default_model_path = os.path.join(get_package_share_directory('diadem_description'), 'urdf/diadem_sim.xacro')
    real_robot_model_path = os.path.join(get_package_share_directory('diadem_description'), 'urdf/diadem.xacro')
